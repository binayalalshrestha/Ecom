...
urlpatterns = [
    ...
    path('product_add/', views.ProductAdding.as_view()),

    path('productapi/<int:id>', views.ProductDetail.as_view()),
    ...
    path('api/products/', views.ProductForSearch.as_view(), name='product-list-api'),
